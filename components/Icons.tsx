/** Inline SVG icons — no icon library, no network requests. */

export type IconName = "github" | "mail" | "linkedin" | "x" | "youtube";
...
export function MailIcon({ className = base }: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
...
export function YouTubeIcon({ className = base }: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
...
export const icons: Record<IconName, (props: Props) => React.ReactElement> = {
  github: GitHubIcon,
  mail: MailIcon,
